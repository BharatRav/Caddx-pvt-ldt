...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2'>
      <div><img src={secondPic} className='w-full h-[90vh]'/></div>
      <div className='bg-black flex flex-col items-center justify-center gap-5 px-12 pt-8 h-full'>
        <h1 className=' text-white font-extrabold capitalize text-5xl text-center'>EMPOWERING YOUR BUSINESS WITH EXPERT IT SOLUTIONS</h1>
