...
const Hero = () => {
  return (
    <div className='grid grid-cols-1 md:grid-cols-2 bg-white'>
      <div className=' md:block hidden'><img src={heroImage} className='w-full h-[90vh]'/></div>
      <div className='bg-black flex flex-col items-center justify-center gap-5 px-12 pt-8 h-full'>
        <h1 className=' text-white font-extrabold capitalize text-3xl md:text-5xl text-center'>EMPOWERING YOUR BUSINESS WITH EXPERT CADX </h1>
